...
------------------------------ Post Data ------------------------------
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-11T13:37:49', '2023-04-11T13:37:49', '자바 집중 스터디', 4, '스터디 주제 : 자바 집중 스터디 강의\n\n스터디 목표 : 자바 문법 및 주요점들 집중 강의\n\n예상 스터디 일정(횟수) : 1달 (주당 1회)\n\n\n\n 1주차: 배열, 객체지향 프로그래밍\n2주차: 예외처리, 유용한 클래스, 컬렉션 프레임웍\n3주차: Generics, 열거형, annotation, 쓰레드\n4주차: 람다와 스트림, 입출력(I/O), 네트워킹\n\nweihyuk@gmail.com로 연락주세요~', 1, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-12T11:07:41', '2023-04-12T11:07:41', '[스프링부트] 직장인 퇴근 후 캠 스터디', 5, '스터디 주제 : 스프링부트 공부 하는 직장인의 퇴근 후 캠스터디\n스터디 목표 : 구루미 캠 켜놓고 스프링부트 각자 공부\n예상 스터디 일정(횟수) : 평일 저녁6시부터, 주말 자율 시작 / 최소3일 , 최소 2시간 이상 각자 계획별로 / 한 달 기준 스터디 지속or종료 선택\n예상 커리큘럼 간략히 : 각자 공부\n예상 모집인원 : 최대 6명\n\nhyoungseok@gmail.com 로 연락주세요', 2, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-13T11:17:45', '2023-04-13T11:17:45', '이펙티브 자바 완벽 공략 스터디', 11, '[개발 스터디 모집 내용 예시]\n\n\n스터디 주제 :이펙티브 자바 완벽 공략 스터디\n스터디 목표 : 이펙티브 자바 완벽 공략 강의를 전부 보고 익힌다. 1부 2부 다.\n예상 스터디 일정(횟수) : 총 8회 (8주)\n예상 커리큘럼 간략히 :강의 계획 세우고 서로 진도 체크하며 독려하기\n예상 모집인원 :5명\n\nralo@gmail.com로 연락주세요.', 6, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-14T11:27:26', '2023-04-14T11:27:26', '여행 커뮤니티 서비스 디자이너 한 분 모집합니다!', 13, '프로젝트 주제 : 여행 커뮤니티 서비스입니다!\n프로젝트 목표 : 기획부터 배포까지 하는 것이 목표입니다.\n프로젝트 소개와 개설 이유 : 국비 부트캠프 마지막 프로젝트에서 저의 역량을 많이 보여주지 못 해 아쉬운 마음에 프로젝트를 새로 하기로 결정했습니다. 각 팀원이 퍼포먼스를 잘 표현 해낼수 있는 프로젝트가 되었으면 좋겠습니다.\n\ndreamcode@gmail.com로 연락주세요!!!', 3, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-15T11:25:19', '2023-04-15T11:25:19', '[서울] App 개발 스터디 - 디자이너 모집', 22, '스터디 주제: 유튜브 Shorts / 인스타 Reels 형태의 사진 등록 어플\n장소 및 일정: 은평구 불광역 / 주 1회 ( 토요일 오후 2시30분 격 주 오프라인 진행 )\n모집 인원: 디자이너 1명\n\n - https://open.kakao.com/o/qqqqqqq', 1, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-16T11:43:18', '2023-04-16T11:43:18', '프론트엔드 면접스터디 하실분', 33, '스터디 주제 : 프론트엔드 면접대비 스터디\n스터디 목표 : 면접에서 조리있고 자신감있게 말하기\n예상 스터디 일정(횟수) : 화,금 오전 10시~13시\n예상 커리큘럼 간략히 : 기술 + 인성 + 각자 프로젝트 기반 질문 진행 (각각 인당 15분씩 진행하고 돌아가면서 진행 및 피드백)\n\n https://open.kakao.com/o/wwwwwwww', 1, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-17T11:24:24', '2023-04-17T11:24:24', 'CS 면접 스터디 같이 하실 분 구합니다!', 31, '[개발 스터디 모집 내용 예시]\n\n스터디 주제 : CS 주제 면접 스터디\n스터디 목표 : CS 면접 성공\n예상 스터디 일정(횟수) : 주 1회\n예상 모집인원 : 5명', 3, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-18T11:57:45', '2023-04-18T11:57:45', '정기 오프 스터디 모임(신림) - 평일,주말 총 주2회 이상 오실 분', 21, '신림역 주변 카페에서 같이 모여서\n개발 관련 공부하실 분들 모집합니다!!\n\n오셔서 공부, 이직준비, 일 등 하시면 되고\n특정 책,주제로 잡고 단기간 하고 끝나는 스터디가 아닌\n꾸준히 계속 같이 공부해가는 장기적인 스터디입니다!!\n\n\n https://open.kakao.com/o/eeeeeeeeee', 1, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-19T11:07:16', '2023-04-19T11:07:16', '[사이드 프로젝트] 백엔드 개발자 구합니다.', 16, '[개발 프로젝트 모집 내용 예시]\n\n프로젝트 주제 : 온라인 서점\n예상 모집인원 : 1명\n프로젝트 관련 주의사항 : 커뮤니케이션 많이 하면서 코드리뷰도 적극적으로 할 예정입니다. 이러한 환경에서 같이 협업하실 분 구해요 코드 컨벤션을 정하고 진행할거라 시간 많이 할애하실 수 있는 분만 지원 부탁드립니다.\nhttps://open.kakao.com/o/aaaaaaaaaa', 5, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-20T11:24:37', '2023-04-20T11:24:37', '퇴근후 계획기반 자율형 스터디 모집합니다!', 7, '계획 기반 자율형 스터디 모집합니다\n\n인원 : 4인~\n시간 : 오후 8시 30분~ 11시 30분 (평일)\n기간 : ~9/15(한달마다 입,퇴부 자유)\n장소/방식 : 매주 일요일 다음주 평일의 계획과 목표 세우기(휴무자유)', 1, 1)
INSERT INTO post(id, active, created_date, last_modified_date, title, hits, content, avatar_id, board_id) values (null, 1, '2023-04-20T11:52:31', '2023-04-20T11:52:31', '리액트 공식문서 읽고 발표하는 스터디', 2, '안녕하세요! 저는 프론트엔드 취업준비생이고 공부한지는 1년 정도 되었습니다!\n\n일요일 오전 시간을 침대에서 밍기적거리는게 너무 아까워서 오전 시간을 활용하기 위한 강제적인 장치를 구상하던 중에 스터디를 모집하게 됐습니다\n또한, React.dev (리액트 공식문서) 가 리뉴얼되고 나서, 블로그에 꾸준히 번역, 정리하며 공부하려 했으나,, 혼자서는 동기도 떨어지고, 제 자신과 자꾸 타협하게 되더라구요..\n그래서, 비슷한 생각을 가지신 분들이 있지 않을까 하여 스터디를 모집하게 됐습니다!', 2, 1)
